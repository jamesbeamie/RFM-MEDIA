"""
Django settings for royalframesmedia project.
...
ALLOWED_HOSTS = ['rfm-app.herokuapp.com']
...
INSTALLED_APPS = [
    ...
    'taggit',
    'cloudinary',
    'royalframesmedia.apps.authentication',
    'royalframesmedia.apps.blog',
    'royalframesmedia.apps.bumps',
    'royalframesmedia.apps.engagements',
...
ROOT_URLCONF = 'royalframesmedia.urls'
...
WSGI_APPLICATION = 'royalframesmedia.wsgi.application'
...
REST_FRAMEWORK = {
    'EXCEPTION_HANDLER': 'royalframesmedia.apps.core.exceptions.core_exception_handler',
